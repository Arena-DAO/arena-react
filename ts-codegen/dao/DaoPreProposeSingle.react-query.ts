...
export const daoPreProposeSingleQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...daoPreProposeSingleQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  proposalModule: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoPreProposeSingleQueryKeys.address(contractAddress)[0],
    method: "proposal_module",
    args
  }] as const),
  dao: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoPreProposeSingleQueryKeys.address(contractAddress)[0],
    method: "dao",
    args
  }] as const),
  config: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoPreProposeSingleQueryKeys.address(contractAddress)[0],
    method: "config",
    args
  }] as const),
  depositInfo: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoPreProposeSingleQueryKeys.address(contractAddress)[0],
    method: "deposit_info",
    args
  }] as const),
  proposalSubmittedHooks: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoPreProposeSingleQueryKeys.address(contractAddress)[0],
    method: "proposal_submitted_hooks",
    args
  }] as const),
  queryExtension: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoPreProposeSingleQueryKeys.address(contractAddress)[0],
...
export function useDaoPreProposeSingleProposalSubmittedHooksQuery<TData = HooksResponse>({
  ...
  return useQuery<HooksResponse, Error, TData>(daoPreProposeSingleQueryKeys.proposalSubmittedHooks(client?.contractAddress), () => client ? client.proposalSubmittedHooks() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoPreProposeSingleConfigQuery<TData = Config>({
  ...
  return useQuery<Config, Error, TData>(daoPreProposeSingleQueryKeys.config(client?.contractAddress), () => client ? client.config() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoPreProposeSingleDaoQuery<TData = Addr>({
  ...
  return useQuery<Addr, Error, TData>(daoPreProposeSingleQueryKeys.dao(client?.contractAddress), () => client ? client.dao() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoPreProposeSingleProposalModuleQuery<TData = Addr>({
  ...
  return useQuery<Addr, Error, TData>(daoPreProposeSingleQueryKeys.proposalModule(client?.contractAddress), () => client ? client.proposalModule() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
