...
export interface DaoVotingCw721StakedInterface extends DaoVotingCw721StakedReadOnlyInterface {
  ...
  claimNfts: (fee?: number | StdFee | "auto", memo?: string, _funds?: Coin[]) => Promise<ExecuteResult>;
  updateConfig: ({
    duration,
    owner
  }: {
...
export class DaoVotingCw721StakedClient extends DaoVotingCw721StakedQueryClient implements DaoVotingCw721StakedInterface {
  ...
  claimNfts = async (fee: number | StdFee | "auto" = "auto", memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      claim_nfts: {}
    }, fee, memo, _funds);
  };
