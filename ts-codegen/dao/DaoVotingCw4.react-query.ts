...
import { DaoVotingCw4QueryClient, DaoVotingCw4Client } from "./DaoVotingCw4.client";
...
export interface DaoVotingCw4MemberChangedHookMutation {
  client: DaoVotingCw4Client;
  msg: {
    diffs: MemberDiff[];
  };
  args?: {
...
export function useDaoVotingCw4MemberChangedHookMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, DaoVotingCw4MemberChangedHookMutation>, "mutationFn">) {
  return useMutation<ExecuteResult, Error, DaoVotingCw4MemberChangedHookMutation>(({
    client,
    msg,
    args: {
      fee,
