...
export interface ArenaPaymentRegistryInterface extends ArenaPaymentRegistryReadOnlyInterface {
  ...
  removeDistribution: (fee?: number | StdFee | "auto", memo?: string, _funds?: Coin[]) => Promise<ExecuteResult>;
}
export class ArenaPaymentRegistryClient extends ArenaPaymentRegistryQueryClient implements ArenaPaymentRegistryInterface {
  ...
  removeDistribution = async (fee: number | StdFee | "auto" = "auto", memo?: string, _funds?: Coin[]): Promise<ExecuteResult> => {
    return await this.client.execute(this.sender, this.contractAddress, {
      remove_distribution: {}
    }, fee, memo, _funds);
  };
