...
import { Uint128, DepositToken, UncheckedDenom, VotingModuleTokenType, DepositRefundPolicy, Admin, Binary, Duration, Decimal, PreProposeSubmissionPolicy, Addr, InstantiateMsg, UncheckedDepositInfo, InstantiateExt, NewCompetitionCategory, ModuleInstantiateInfo, Coin, NewRuleset, TaxConfiguration, ExecuteMsg, ExecuteExt, EditCompetitionCategory, Status, Expiration, Timestamp, Uint64, ProposeMessage, FeeInformationForString, DistributionForString, MemberPercentageForString, MemberResultForString, QueryMsg, QueryExt, CompetitionModuleQuery, MigrateMsg, MigrateExt, SudoMsg, CompetitionCategory, DumpStateResponse, CompetitionModuleResponseForString, Rating, BlockInfo, Ruleset, Boolean, CheckedDenom, Config, CheckedDepositInfo, DepositInfoResponse, InfoResponse, ContractVersion, HooksResponse } from "./ArenaCore.types";
...
export const arenaCoreQueries = {
  ...
  info: <TData = InfoResponse,>({
    client,
    options
  }: ArenaCoreInfoQuery<TData>): UseQueryOptions<InfoResponse, Error, TData> => ({
    queryKey: arenaCoreQueryKeys.info(client?.contractAddress),
  ...
  canPropose: <TData = Boolean,>({
    ...
    args,
    options
  }: ArenaCoreCanProposeQuery<TData>): UseQueryOptions<Boolean, Error, TData> => ({
    queryKey: arenaCoreQueryKeys.canPropose(client?.contractAddress, args),
...
export function useArenaCoreProposalSubmittedHooksQuery<TData = HooksResponse>({
  ...
  return useQuery<HooksResponse, Error, TData>(arenaCoreQueryKeys.proposalSubmittedHooks(client?.contractAddress), () => client ? client.proposalSubmittedHooks() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
export interface ArenaCoreCanProposeQuery<TData> extends ArenaCoreReactQuery<Boolean, TData> {
  args: {
    address: string;
  };
}
export function useArenaCoreCanProposeQuery<TData = Boolean>({
  client,
  args,
  options
}: ArenaCoreCanProposeQuery<TData>) {
  return useQuery<Boolean, Error, TData>(arenaCoreQueryKeys.canPropose(client?.contractAddress, args), () => client ? client.canPropose({
    address: args.address
  }) : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
...
export function useArenaCoreConfigQuery<TData = Config>({
  ...
  return useQuery<Config, Error, TData>(arenaCoreQueryKeys.config(client?.contractAddress), () => client ? client.config() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
export interface ArenaCoreInfoQuery<TData> extends ArenaCoreReactQuery<InfoResponse, TData> {}
export function useArenaCoreInfoQuery<TData = InfoResponse>({
  client,
  options
}: ArenaCoreInfoQuery<TData>) {
  return useQuery<InfoResponse, Error, TData>(arenaCoreQueryKeys.info(client?.contractAddress), () => client ? client.info() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useArenaCoreDaoQuery<TData = Addr>({
  ...
  return useQuery<Addr, Error, TData>(arenaCoreQueryKeys.dao(client?.contractAddress), () => client ? client.dao() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useArenaCoreProposalModuleQuery<TData = Addr>({
  ...
  return useQuery<Addr, Error, TData>(arenaCoreQueryKeys.proposalModule(client?.contractAddress), () => client ? client.proposalModule() : Promise.reject(new Error("Invalid client")), {
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export interface ArenaCoreUpdateSubmissionPolicyMutation {
  client: ArenaCoreClient;
  msg: {
    allowlistAdd?: string[];
...
export function useArenaCoreUpdateSubmissionPolicyMutation(options?: Omit<UseMutationOptions<ExecuteResult, Error, ArenaCoreUpdateSubmissionPolicyMutation>, "mutationFn">) {
  return useMutation<ExecuteResult, Error, ArenaCoreUpdateSubmissionPolicyMutation>(({
    client,
    msg,
    args: {
      fee,
