...
export const daoDaoCoreQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...daoDaoCoreQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  admin: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "admin",
    args
  }] as const),
  adminNomination: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "admin_nomination",
    args
  }] as const),
  config: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "config",
    args
  }] as const),
  cw20Balances: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "cw20_balances",
    args
  }] as const),
  cw20TokenList: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "cw20_token_list",
    args
  }] as const),
  cw721TokenList: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "cw721_token_list",
    args
  }] as const),
  dumpState: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "dump_state",
    args
  }] as const),
  getItem: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "get_item",
    args
  }] as const),
  listItems: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "list_items",
    args
  }] as const),
  info: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "info",
    args
  }] as const),
  proposalModules: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "proposal_modules",
    args
  }] as const),
  activeProposalModules: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "active_proposal_modules",
    args
  }] as const),
  proposalModuleCount: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "proposal_module_count",
    args
  }] as const),
  pauseInfo: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "pause_info",
    args
  }] as const),
  votingModule: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "voting_module",
    args
  }] as const),
  listSubDaos: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "list_sub_daos",
    args
  }] as const),
  daoURI: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "dao_u_r_i",
    args
  }] as const),
  votingPowerAtHeight: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
    method: "voting_power_at_height",
    args
  }] as const),
  totalPowerAtHeight: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...daoDaoCoreQueryKeys.address(contractAddress)[0],
...
export const daoDaoCoreQueries = {
  ...
  cw20Balances: <TData = Cw20BalanceResponse,>({
    ...
    args,
    options
  }: DaoDaoCoreCw20BalancesQuery<TData>): UseQueryOptions<Cw20BalanceResponse, Error, TData> => ({
  ...
  listItems: <TData = ArrayOfString,>({
    ...
    args,
    options
  }: DaoDaoCoreListItemsQuery<TData>): UseQueryOptions<ArrayOfString, Error, TData> => ({
...
export function useDaoDaoCoreDaoURIQuery<TData = DaoURIResponse>({
  ...
  return useQuery<DaoURIResponse, Error, TData>(daoDaoCoreQueryKeys.daoURI(client?.contractAddress), () => client ? client.daoURI() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoDaoCoreVotingModuleQuery<TData = Addr>({
  ...
  return useQuery<Addr, Error, TData>(daoDaoCoreQueryKeys.votingModule(client?.contractAddress), () => client ? client.votingModule() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoDaoCorePauseInfoQuery<TData = PauseInfoResponse>({
  ...
  return useQuery<PauseInfoResponse, Error, TData>(daoDaoCoreQueryKeys.pauseInfo(client?.contractAddress), () => client ? client.pauseInfo() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoDaoCoreProposalModuleCountQuery<TData = ProposalModuleCountResponse>({
  ...
  return useQuery<ProposalModuleCountResponse, Error, TData>(daoDaoCoreQueryKeys.proposalModuleCount(client?.contractAddress), () => client ? client.proposalModuleCount() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoDaoCoreInfoQuery<TData = InfoResponse>({
  ...
  return useQuery<InfoResponse, Error, TData>(daoDaoCoreQueryKeys.info(client?.contractAddress), () => client ? client.info() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoDaoCoreListItemsQuery<TData = ArrayOfString>({
  ...
  return useQuery<ArrayOfString, Error, TData>(daoDaoCoreQueryKeys.listItems(client?.contractAddress, args), () => client ? client.listItems({
    limit: args.limit,
    startAfter: args.startAfter
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
...
export function useDaoDaoCoreDumpStateQuery<TData = DumpStateResponse>({
  ...
  return useQuery<DumpStateResponse, Error, TData>(daoDaoCoreQueryKeys.dumpState(client?.contractAddress), () => client ? client.dumpState() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoDaoCoreCw20BalancesQuery<TData = Cw20BalanceResponse>({
  ...
  return useQuery<Cw20BalanceResponse, Error, TData>(daoDaoCoreQueryKeys.cw20Balances(client?.contractAddress, args), () => client ? client.cw20Balances({
    limit: args.limit,
    startAfter: args.startAfter
  }) : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
...
export function useDaoDaoCoreConfigQuery<TData = Config>({
  ...
  return useQuery<Config, Error, TData>(daoDaoCoreQueryKeys.config(client?.contractAddress), () => client ? client.config() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoDaoCoreAdminNominationQuery<TData = AdminNominationResponse>({
  ...
  return useQuery<AdminNominationResponse, Error, TData>(daoDaoCoreQueryKeys.adminNomination(client?.contractAddress), () => client ? client.adminNomination() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useDaoDaoCoreAdminQuery<TData = Addr>({
  ...
  return useQuery<Addr, Error, TData>(daoDaoCoreQueryKeys.admin(client?.contractAddress), () => client ? client.admin() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
