...
export const cwAbcQueryKeys = {
  ...
  address: (contractAddress: string | undefined) => ([{ ...cwAbcQueryKeys.contract[0],
    address: contractAddress
  }] as const),
  curveInfo: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "curve_info",
    args
  }] as const),
  curveType: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "curve_type",
    args
  }] as const),
  denom: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "denom",
    args
  }] as const),
  donations: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "donations",
    args
  }] as const),
  isPaused: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "is_paused",
    args
  }] as const),
  fundingPoolForwarding: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "funding_pool_forwarding",
    args
  }] as const),
  hatchers: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "hatchers",
    args
  }] as const),
  hatcher: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "hatcher",
    args
  }] as const),
  hatcherAllowlist: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "hatcher_allowlist",
    args
  }] as const),
  maxSupply: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "max_supply",
    args
  }] as const),
  buyQuote: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "buy_quote",
    args
  }] as const),
  sellQuote: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "sell_quote",
    args
  }] as const),
  phase: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "phase",
    args
  }] as const),
  phaseConfig: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "phase_config",
    args
  }] as const),
  tokenContract: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "token_contract",
    args
  }] as const),
  ownership: (contractAddress: string | undefined, args?: Record<string, unknown>) => ([{ ...cwAbcQueryKeys.address(contractAddress)[0],
    method: "ownership",
    args
  }] as const)
};
export const cwAbcQueries = {
  curveInfo: <TData = CurveInfoResponse,>({
    client,
    options
  }: CwAbcCurveInfoQuery<TData>): UseQueryOptions<CurveInfoResponse, Error, TData> => ({
    queryKey: cwAbcQueryKeys.curveInfo(client?.contractAddress),
    queryFn: () => client ? client.curveInfo() : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  curveType: <TData = CurveType,>({
    client,
    options
  }: CwAbcCurveTypeQuery<TData>): UseQueryOptions<CurveType, Error, TData> => ({
    queryKey: cwAbcQueryKeys.curveType(client?.contractAddress),
    queryFn: () => client ? client.curveType() : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  denom: <TData = DenomResponse,>({
    client,
    options
  }: CwAbcDenomQuery<TData>): UseQueryOptions<DenomResponse, Error, TData> => ({
    queryKey: cwAbcQueryKeys.denom(client?.contractAddress),
    queryFn: () => client ? client.denom() : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  donations: <TData = DonationsResponse,>({
    client,
    args,
    options
  }: CwAbcDonationsQuery<TData>): UseQueryOptions<DonationsResponse, Error, TData> => ({
    queryKey: cwAbcQueryKeys.donations(client?.contractAddress, args),
    queryFn: () => client ? client.donations({
      limit: args.limit,
  ...
  isPaused: <TData = Boolean,>({
    client,
    options
  }: CwAbcIsPausedQuery<TData>): UseQueryOptions<Boolean, Error, TData> => ({
    queryKey: cwAbcQueryKeys.isPaused(client?.contractAddress),
    queryFn: () => client ? client.isPaused() : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  fundingPoolForwarding: <TData = NullableAddr,>({
    client,
    options
  }: CwAbcFundingPoolForwardingQuery<TData>): UseQueryOptions<NullableAddr, Error, TData> => ({
    queryKey: cwAbcQueryKeys.fundingPoolForwarding(client?.contractAddress),
    queryFn: () => client ? client.fundingPoolForwarding() : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  hatchers: <TData = HatchersResponse,>({
    client,
    args,
    options
  }: CwAbcHatchersQuery<TData>): UseQueryOptions<HatchersResponse, Error, TData> => ({
    queryKey: cwAbcQueryKeys.hatchers(client?.contractAddress, args),
    queryFn: () => client ? client.hatchers({
      limit: args.limit,
      startAfter: args.startAfter
    }) : Promise.reject(new Error("Invalid client")),
    ...options,
  ...
  hatcher: <TData = Uint128,>({
    client,
    args,
    options
  }: CwAbcHatcherQuery<TData>): UseQueryOptions<Uint128, Error, TData> => ({
    queryKey: cwAbcQueryKeys.hatcher(client?.contractAddress, args),
    queryFn: () => client ? client.hatcher({
      addr: args.addr
    }) : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  hatcherAllowlist: <TData = HatcherAllowlistResponse,>({
    client,
    args,
    options
  }: CwAbcHatcherAllowlistQuery<TData>): UseQueryOptions<HatcherAllowlistResponse, Error, TData> => ({
    queryKey: cwAbcQueryKeys.hatcherAllowlist(client?.contractAddress, args),
    queryFn: () => client ? client.hatcherAllowlist({
  ...
  maxSupply: <TData = Uint128,>({
    client,
    options
  }: CwAbcMaxSupplyQuery<TData>): UseQueryOptions<Uint128, Error, TData> => ({
    queryKey: cwAbcQueryKeys.maxSupply(client?.contractAddress),
    queryFn: () => client ? client.maxSupply() : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  buyQuote: <TData = QuoteResponse,>({
    client,
    args,
    options
  }: CwAbcBuyQuoteQuery<TData>): UseQueryOptions<QuoteResponse, Error, TData> => ({
    queryKey: cwAbcQueryKeys.buyQuote(client?.contractAddress, args),
    queryFn: () => client ? client.buyQuote({
      payment: args.payment
    }) : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  sellQuote: <TData = QuoteResponse,>({
    client,
    args,
    options
  }: CwAbcSellQuoteQuery<TData>): UseQueryOptions<QuoteResponse, Error, TData> => ({
    queryKey: cwAbcQueryKeys.sellQuote(client?.contractAddress, args),
    queryFn: () => client ? client.sellQuote({
      payment: args.payment
    }) : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  phase: <TData = CommonsPhase,>({
    client,
    options
  }: CwAbcPhaseQuery<TData>): UseQueryOptions<CommonsPhase, Error, TData> => ({
    queryKey: cwAbcQueryKeys.phase(client?.contractAddress),
    queryFn: () => client ? client.phase() : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  phaseConfig: <TData = CommonsPhaseConfigResponse,>({
    client,
    options
  }: CwAbcPhaseConfigQuery<TData>): UseQueryOptions<CommonsPhaseConfigResponse, Error, TData> => ({
    queryKey: cwAbcQueryKeys.phaseConfig(client?.contractAddress),
    queryFn: () => client ? client.phaseConfig() : Promise.reject(new Error("Invalid client")),
    ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  }),
  tokenContract: <TData = Addr,>({
    client,
    options
  }: CwAbcTokenContractQuery<TData>): UseQueryOptions<Addr, Error, TData> => ({
    queryKey: cwAbcQueryKeys.tokenContract(client?.contractAddress),
  ...
  ownership: <TData = OwnershipForString,>({
    client,
    options
  }: CwAbcOwnershipQuery<TData>): UseQueryOptions<OwnershipForString, Error, TData> => ({
    queryKey: cwAbcQueryKeys.ownership(client?.contractAddress),
...
export function useCwAbcOwnershipQuery<TData = OwnershipForString>({
  ...
  return useQuery<OwnershipForString, Error, TData>(cwAbcQueryKeys.ownership(client?.contractAddress), () => client ? client.ownership() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcTokenContractQuery<TData = Addr>({
  ...
  return useQuery<Addr, Error, TData>(cwAbcQueryKeys.tokenContract(client?.contractAddress), () => client ? client.tokenContract() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcPhaseConfigQuery<TData = CommonsPhaseConfigResponse>({
  ...
  return useQuery<CommonsPhaseConfigResponse, Error, TData>(cwAbcQueryKeys.phaseConfig(client?.contractAddress), () => client ? client.phaseConfig() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcPhaseQuery<TData = CommonsPhase>({
  ...
  return useQuery<CommonsPhase, Error, TData>(cwAbcQueryKeys.phase(client?.contractAddress), () => client ? client.phase() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcMaxSupplyQuery<TData = Uint128>({
  ...
  return useQuery<Uint128, Error, TData>(cwAbcQueryKeys.maxSupply(client?.contractAddress), () => client ? client.maxSupply() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcFundingPoolForwardingQuery<TData = NullableAddr>({
  ...
  return useQuery<NullableAddr, Error, TData>(cwAbcQueryKeys.fundingPoolForwarding(client?.contractAddress), () => client ? client.fundingPoolForwarding() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcIsPausedQuery<TData = Boolean>({
  ...
  return useQuery<Boolean, Error, TData>(cwAbcQueryKeys.isPaused(client?.contractAddress), () => client ? client.isPaused() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcDenomQuery<TData = DenomResponse>({
  ...
  return useQuery<DenomResponse, Error, TData>(cwAbcQueryKeys.denom(client?.contractAddress), () => client ? client.denom() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcCurveTypeQuery<TData = CurveType>({
  ...
  return useQuery<CurveType, Error, TData>(cwAbcQueryKeys.curveType(client?.contractAddress), () => client ? client.curveType() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
...
export function useCwAbcCurveInfoQuery<TData = CurveInfoResponse>({
  ...
  return useQuery<CurveInfoResponse, Error, TData>(cwAbcQueryKeys.curveInfo(client?.contractAddress), () => client ? client.curveInfo() : Promise.reject(new Error("Invalid client")), { ...options,
    enabled: !!client && (options?.enabled != undefined ? options.enabled : true)
  });
}
