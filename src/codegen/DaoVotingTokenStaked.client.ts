...
export class DaoVotingTokenStakedQueryClient implements DaoVotingTokenStakedReadOnlyInterface {
...
export interface DaoVotingTokenStakedInterface extends DaoVotingTokenStakedReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class DaoVotingTokenStakedClient extends DaoVotingTokenStakedQueryClient implements DaoVotingTokenStakedInterface {
