...
const getEnv = (): Env => {
	if (!cachedEnv) {
		const env = {
			...
			ARENA_TOURNAMENT_MODULE_ADDRESS: process.env.NEXT_PUBLIC_ARENA_TOURNAMENT_MODULE_ADDRESS,
			...
			ARENA_PAYMENT_REGISTRY_ADDRESS: process.env.NEXT_PUBLIC_ARENA_PAYMENT_REGISTRY_ADDRESS,
			ARENA_TOKEN_GATEWAY_ADDRESS: process.env.NEXT_PUBLIC_ARENA_TOKEN_GATEWAY_ADDRESS,
			ARENA_DISCORD_IDENTITY_ADDRESS: process.env.NEXT_PUBLIC_ARENA_DISCORD_IDENTITY_ADDRESS,
			ARENA_TEAM_ENROLLMENTS_ADDRESS: process.env.NEXT_PUBLIC_ARENA_TEAM_ENROLLMENTS_ADDRESS,
			...
			DEFAULT_TEAM_VOTING_DURATION_TIME: process.env.NEXT_PUBLIC_DEFAULT_TEAM_VOTING_DURATION_TIME,
			...
			CODE_ID_DAO_PROPOSAL_SINGLE: process.env.NEXT_PUBLIC_CODE_ID_DAO_PROPOSAL_SINGLE,
			CODE_ID_DAO_PREPROPOSE_SINGLE: process.env.NEXT_PUBLIC_CODE_ID_DAO_PREPROPOSE_SINGLE,
		};
